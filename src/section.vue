          ...
          >
            ...
            >
              <wwObject
                ...
                :class="{
                  selected: isFeatureSelected(feature, selectedFeature),
                }"
        ...
        <div class="right-wrapper">
          ...
          <transition name="fade">
            <div class="feature-display-wrapper">
              <wwObject
                class="feature-display-content"
                v-for="(feature, index) in section.data.features"
                :key="index"
                :class="{ active: isFeatureSelected(feature, selectedFeature) }"
                :ww-object="feature.display"
              ></wwObject>
            </div>
          </transition>
        </div>
...
export default {
  ...
  methods: {
    ...
    removeFeature(feature) {
      ...
      this.section.data.features = features.filter(
        (aFeature) => aFeature !== feature
      );
      this.update();
    },
    update() {
